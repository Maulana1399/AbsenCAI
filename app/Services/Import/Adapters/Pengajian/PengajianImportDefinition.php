...
final class PengajianImportDefinition implements ImportDefinition
{
    ...
    public function key(): string { return 'pengajian'; }
    public function label(): string { return 'Import Massal Pengajian'; }
