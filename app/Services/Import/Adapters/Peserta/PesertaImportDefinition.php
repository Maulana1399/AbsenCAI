...
final class PesertaImportDefinition implements ImportDefinition
{
    ...
    public function key(): string { return 'peserta'; }
    public function label(): string { return 'Import Peserta'; }
