                    ...
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-900/50">
                        ...
                        <td class="whitespace-nowrap px-4 py-3 text-sm">
                            <div class="flex flex-wrap items-center gap-1">
                                ...
                                @endif
                                @if (!$event->hasRuntimeDependencies() && $event->slug !== 'cai-operational')
                                    <flux:button wire:click="confirmDelete({{ $event->id }})" size="sm" icon-trailing="trash" variant="danger">Hapus</flux:button>
                                @endif
                            </div>
                        </td>
                    </tr>
        ...
        @if ($deleteEventId)
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4"
                ...
                <div class="w-full max-w-sm rounded-xl border border-zinc-200 bg-white p-6 shadow-xl dark:border-zinc-700 dark:bg-zinc-900">
                    <p class="text-base font-bold text-red-700 dark:text-red-400">Hapus Event?</p>
