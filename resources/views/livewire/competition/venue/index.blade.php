<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Kelola tempat/lokasi perlombaan.</p>
        </div>
    ...
    @if ($showCreateForm)
        <div class="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-zinc-700 dark:text-zinc-300">Lokasi</label>
        ...
        <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-800">
            <thead class="bg-zinc-50 dark:bg-zinc-900">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-zinc-500">Lokasi</th>
            ...
            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-8 text-center text-sm text-zinc-500">Belum ada venue.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
