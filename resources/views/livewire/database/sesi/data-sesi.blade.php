        ...
        <table class="w-full text-sm text-left text-zinc-700 dark:text-zinc-300">
            <thead class="text-xs uppercase bg-zinc-50 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400">
                <tr>
                        ...
                        <th class="px-4 py-3 border-b border-zinc-200 dark:border-zinc-700">Nama Sesi</th>
                        <th class="px-4 py-3 border-b border-zinc-200 dark:border-zinc-700">Tanggal</th>
                        <th class="px-4 py-3 border-b border-zinc-200 dark:border-zinc-700">Aktif</th>
            ...
            @foreach($daftarSesi as $sesi)
                <tr class="bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-900">
                    ...
                    <td class="px-4 py-3">{{ $sesi->nama_sesi }}</td>
                    <td class="px-4 py-3">{{ $sesi->tanggal }}</td>
                    <td class="px-4 py-3">
                        @if($sesi->aktif)
