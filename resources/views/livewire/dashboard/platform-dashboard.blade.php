...
<div class="flex items-start justify-between">
    ...
    <section>
        ...
        @php
            ...
            $singleEvent = $activeCount === 1 ? $events->first() : null;

            $multiEvent = $activeCount > 1;
        ...
        <div class="grid gap-4 sm:grid-cols-3">
            ...
            <div class="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                ...
                @elseif($multiEvent)
                    ...
                    <flux:modal.trigger name="quick-access-scan">

                        <flux:button variant="ghost" size="sm" class="mt-3 w-full">
            ...
            <div class="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                ...
                @elseif($multiEvent)
                    ...
                    <flux:modal.trigger name="quick-access-registrasi">
            ...
            <div class="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                ...
                @elseif($multiEvent)
                    ...
                    <flux:modal.trigger name="quick-access-cari">
    ...
    @if($multiEvent)
        ...
        @php
            ...
            $quickAccessTargets = [
                ...
                'scan' => ['name' => 'quick-access-scan', 'title' => 'Scan QR'],

                'registrasi' => ['name' => 'quick-access-registrasi', 'title' => 'Registrasi Peserta'],

                'cari' => ['name' => 'quick-access-cari', 'title' => 'Cari Peserta'],
        ...
        @foreach($quickAccessTargets as $target => $modal)

            <flux:modal name="{{ $modal['name'] }}" class="md:w-96">

                <div class="space-y-4">

                    <flux:heading size="lg">{{ $modal['title'] }}</flux:heading>

                    <p class="text-sm text-zinc-500 dark:text-zinc-400">

                        {{ __('Pilih event untuk dibuka.') }}
                    ...
                    <div class="max-h-72 space-y-2 overflow-y-auto">
                        ...
                        @foreach($events as $event)
                            ...
                            <flux:button
                                ...
                                wire:click="openQuickAccess('{{ $target }}', {{ $event->id }})"
