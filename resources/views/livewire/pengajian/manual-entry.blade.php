<div class="flex flex-col gap-6">
    <div class="text-center mb-2">
        ...
        <p class="text-emerald-600 text-lg mt-1">{{ $eventName }}</p>
        <p class="text-zinc-500 text-sm mt-1">{{ $desaName }}</p>
    </div>
    ...
    @if ($step === 1)
        <div class="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
            <p class="text-xs text-zinc-400 mb-4">
                Isi data warga desa yang belum terdaftar sebagai peserta.
            </p>
            ...
            <form wire:submit="submit" class="flex flex-col gap-4">
                ...
                <div class="rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-400">
                    <span class="font-medium">Event:</span> {{ $eventName }}<br>
                    <span class="font-medium">Desa:</span> {{ $desaName }}
                </div>
            ...
            <div class="mt-4">
                <flux:button wire:click="goToDashboard" variant="ghost" class="w-full">
                    &larr; Kembali ke Dashboard Desa
                </flux:button>
            </div>
        </div>
    @endif
