...
test('EditPeserta rejects Event A context for Event B only participation', function () {
    ...
    $legacy = peserta::create(['nama' => 'Only B', 'nip' => 90011, 'jenis_kelamin' => 'Laki - Laki', 'jenis_peserta' => 'Wajib', 'desa_id' => null, 'kelompok_id' => null, 'status_registrasi' => peserta::STATUS_BELUM_REGISTRASI]);
...
test('Existing Person joining Event B through registration follows Case B without duplicating global records', function () {
    ...
    $legacy = peserta::create(['nama' => 'Case B Person', 'nip' => 90021, 'jenis_kelamin' => 'Laki - Laki', 'jenis_peserta' => 'Wajib', 'desa_id' => null, 'kelompok_id' => null, 'status_registrasi' => peserta::STATUS_BELUM_REGISTRASI]);
